...
I did my bachelor’s study at RWTH Aachen University in Germany, majoring in Computer Engineering. My final year thesis and research at the senior stage is about hardware security, supervised by Professor [Rainer Leupers](https://scholar.google.com/citations?user=f57N-_oAAAAJ&hl=de). Specifically, the thesis is about how to do logic encryption on chips. I spend one year working on my thesis and as an RA later. 
